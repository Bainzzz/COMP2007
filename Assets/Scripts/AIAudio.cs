...
public class AIAudio : MonoBehaviour
{
    ...
    [SerializeField] private float attackDistance = 1f; // Distance to "hit" player and trigger lose
    ...
    {
        // Option 1: Load a lose scene (commented out)
        // SceneManager.LoadScene("LoseScene");

        // Option 2: Display a lose message and pause (for testing)
